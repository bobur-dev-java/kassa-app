...
public class SmallSellerController {
    ...
    public ResponseEntity<HttpApiResponse<MoneyTransactionResponse>> getMoneyTransactionById(
        ...
        HttpApiResponse<MoneyTransactionResponse> response = smallSellerService.getMoneyTransactionById(id);
        return ResponseEntity.status(response.getStatus()).body(response);
    }
    ...
    public ResponseEntity<HttpApiResponse<ProductTransactionResponse>> getProductTransactionById(
        ...
        HttpApiResponse<ProductTransactionResponse> response = smallSellerService.getProductTransactionById(id);
        return ResponseEntity.status(response.getStatus()).body(response);
    }
    ...
    public ResponseEntity<HttpApiResponse<KassaResponse>> getKassaById(
        ...
        HttpApiResponse<KassaResponse> response = smallSellerService.getKassaById(id);
        return ResponseEntity.status(response.getStatus()).body(response);
    }
    ...
    public ResponseEntity<HttpApiResponse<Long>> updateProductTransaction(@PathVariable Long id, @RequestBody ProductTransactionUpdate request) throws AccessDeniedException {
        HttpApiResponse<Long> response = smallSellerService.updateProductTransaction(request, id);
        return ResponseEntity.status(response.getStatus()).body(response);
    }
    ...
    public ResponseEntity<HttpApiResponse<Long>> updateMoneyTransaction(@PathVariable Long id, @RequestBody MoneyTransactionUpdate request) throws AccessDeniedException {
        HttpApiResponse<Long> response = smallSellerService.updateMoneyTransaction(request, id);
        return ResponseEntity.status(response.getStatus()).body(response);
    }

    @PutMapping("/kassa/{id}")
    public ResponseEntity<HttpApiResponse<Long>> updateKassaById(@PathVariable Long id, @RequestBody KassaUpdateRequest request) {
        HttpApiResponse<Long> response = smallSellerService.updateKassaById(request, id);
        return ResponseEntity.status(response.getStatus()).body(response);
    }
